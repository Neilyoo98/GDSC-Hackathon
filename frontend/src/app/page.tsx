...
export default function Home() {
  return (
    ...
    >
      ...
      <section id="architecture" className="mx-6 mb-16 overflow-hidden border border-[#e8e4dc33] md:mx-10">
      ...
      <section className="grid grid-cols-2 px-6 py-16 md:grid-cols-4 md:px-10">
        {[
      ...
      <section id="team" className="px-6 py-20 md:px-10">
      ...
      <footer className="grid grid-cols-1 items-center gap-4 border-t border-[#1f1f1f] px-6 py-7 md:grid-cols-3 md:px-10">
